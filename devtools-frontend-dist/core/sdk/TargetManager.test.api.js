...
describe('TargetManager API Test', () => {
    it('suspends and resumes all targets and their agents', async ({ inspectedPage, universe }) => {
        ...
        universe.targetManager.addEventListener("SuspendStateChanged" /* SDK.TargetManager.Events.SUSPEND_STATE_CHANGED */, listener);
        ...
        universe.targetManager.removeEventListener("SuspendStateChanged" /* SDK.TargetManager.Events.SUSPEND_STATE_CHANGED */, listener);
    });
});
//# sourceMappingURL=TargetManager.test.api.js.map